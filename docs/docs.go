    ...
    "paths": {
        ...
        "/auth/otp/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Email, OTP code, and timezone",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.TodayResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.LogTaskRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateTimezoneRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CheckTimezoneRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CheckTimezoneResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "dto.TodayResponse": {
            ...
            "properties": {
                "check_ins": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.TaskWithLogResponse"
                    }
                },
                "date": {
                    "type": "string"
